...
func NewServer(
	...
	r.Route("/admin/api", func(r chi.Router) {
		...
		r.Post("/functions/{id}/invoke/stream", fh.InvokeFunctionStreamWithEvent)
		r.Get("/functions/{id}/versions", fh.ListFunctionVersions)
		r.Get("/functions/{id}/versions/{versionId}", fh.GetFunctionVersion)
