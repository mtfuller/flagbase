...
func runStart(_ *cobra.Command, _ []string) error {
	...
	srv := api.NewServer(cfg, db, iamSvc, featureEng, store, bus, bgWorker, setupMgr, fnStore, frontendSvc, tableEng, triggerEng, tracer, pkgStore)
